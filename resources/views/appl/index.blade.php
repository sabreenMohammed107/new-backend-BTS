                       ...
                       <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-100px" style="width: 50px !important"> First Name</th>
                                <th class="min-w-100px">Last Name</th>
                                <th class="min-w-100px">Salution</th>
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            <tr>
                                ...
                                <!--begin::Course-->
                                <td>
                                    <span class="fw-bolder">{{ $row->last_name }}</span>
                                </td>
                                <!--end::Course-->
                                ...
                                <!--begin::Register Date-->
                                <td>
                                    <span class="fw-bolder">{{ $row->salut->en_name ?? '' }}</span>
                                </td>
                                <!--end::Register Date-->
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                            ...
                                            <form id="delete_{{ $row->id }}" action="{{ route('appl.destroy', $row->id) }}" method="POST" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </div>
