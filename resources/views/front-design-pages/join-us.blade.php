...
<body>
  ...
  <div class="body-wrapper" id="join-us-page">
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="join-us-card">
                  <img src="img/bg/Join the speakers and make an impact!.png" alt="">
              ...
              <div class="col-lg-6">
                <div class="join-us-card">
                  <img src="img/bg/Join our team and grow with us.png" alt="">
                  <div class="card-overlay"></div>
                  <div class="join-us-cart-data">
