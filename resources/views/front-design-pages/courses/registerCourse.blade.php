                    ...
                    <form action="{{ url('/registerApplicantRounds') }}" method="POST">
                                    ...
                                    @isset($course_rounds)
                                        @foreach ($course_rounds as $course_round)
                                            ...
                                            <option value="{{ $course_round->id }}"
                                                ...
                                                {{ date_format($date, 'd-m-Y') }} | {{ $course_round->country->country_en_name }}
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 mb-3">
                                ...
                                <input  name="job_title" type="text" value="{{ old('job_title') }}" class="form-control" id="designation" required>
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="tel" class="form-control" name="phone" value="{{ old('phone') }}" id="phone" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="fax" value="{{ old('fax') }}"  class="form-control" id="fax" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="fullName" class="form-label required">Full Name</label>
                                <input type="text" class="form-control" name="billing_name" value="{{ old('billing_name') }}" id="fullName" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6 mb-3">
                                <label for="designation" class="form-label required">Designation</label>
                                <input type="text" name="billing_job_title" value="{{ old('billing_job_title') }}" class="form-control" id="designation" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="company" class="form-label required">Company</label>
                                <input type="text" name="billing_company" value="{{ old('billing_company') }}" class="form-control" id="company" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6 mb-3">
                                <label for="address" class="form-label required">Address</label>
                                <input type="text" name="billing_address" value="{{ old('billing_address') }}"  class="form-control" id="address" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="phone" class="form-label required">Phone</label>
                                <input type="tel" name="billing_phone" value="{{ old('billing_phone') }}" class="form-control" id="phone" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 mb-3">
                                <label for="email" class="form-label required">Email</label>
                                <input type="email" name="billing_email" value="{{ old('billing_email') }}" class="form-control" id="email" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="fax" class="form-label required">Fax</label>
                                <input type="text" name="billing_fax" value="{{ old('billing_fax') }}" class="form-control" id="fax" required>
                            </div>
                        </div>
