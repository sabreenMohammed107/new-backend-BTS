...
/* Service Card Hover Effect for Course Cards (match Request InHouse) */
.ltn__product-item-3 {
    position: relative;
    overflow: hidden;
    border-radius: 12px;
...
#personal_city + .nice-select .list {
    ...
    <div class="main-course-bg-header">
        ...
        <div class="course-main-title text-center">
            <h2>Request For Online Proposal</h2>
        </div>
    </div>
                        ...
                        <div class="ltn__product-item ltn__product-item-3 text-left w-100">
                            <div class="product-img shine">
                                <a class="img-container" href="{{ url('courseDetails/'.$round->course->id) }}">
                                    <img
                                        src="{{ $round->course->course_image_thumbnail ? asset('uploads/courses/' . $round->course->course_image_thumbnail) : asset('front-assets/img/No-Image-Placeholder.svg.png') }}"
