                        ...
                        <form action="{{ route('searchCourse.index') }}" method="GET" id="search-form">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 col-lg-4 col-xl-3 mt-2 mt-lg-0">
                                    <div class="">
                                        <select class="" name="category_id" aria-label="Default select example">
                                            <option selected>Category</option>
                                            @isset($subCategories)
                                                @foreach ($subCategories as $subCategory)
                                                    <option value="{{ $subCategory->id }}">
                                                        {{ $subCategory->subcategory_en_name }}</option>
                                                @endforeach
                                            @endisset
                                        </select>
                                    </div>
                                ...
                                <div class="col-12 col-md-6 col-lg-4 col-xl-3 mt-2 mt-lg-0">
                                    <div class="mc-field-group">
                                        <select class="" aria-label="Default select example" name="city_id">
