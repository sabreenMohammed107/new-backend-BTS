...
@section('content')
    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
        <div class="container-xxl">
            ...
            <form class="form d-flex flex-column flex-lg-row" action="{{ route('consultancyUpdate') }}" method="POST" enctype="multipart/form-data">
                @csrf
  ...
  <div class="mb-10 fv-row">
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('consultancyView') }}" class="btn btn-light me-5">Cancel</a>
