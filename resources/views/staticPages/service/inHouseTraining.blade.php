    ...
    <div class="toolbar" id="kt_toolbar">
        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                <h1 class="text-dark fw-bolder my-1 fs-2">In House Training</h1>
                <ul class="breadcrumb fw-bold fs-base my-1">
                    <li class="breadcrumb-item text-muted">
                        <a href="#" class="text-muted text-hover-primary">Home</a>
                    </li>
                    <li class="breadcrumb-item text-muted">In House Training</li>
...
@section('content')
    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
        <div class="container-xxl">
            ...
            <form class="form d-flex flex-column flex-lg-row" action="{{ route('inHouseTrainingUpdate') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                    <div class="card card-flush py-4">
                        <div class="card-header">
                            <div class="card-title">
                                <h2>In House Training Information</h2>
                            </div>
                        </div>
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('inHouseTrainingView') }}" class="btn btn-light me-5">Cancel</a>
