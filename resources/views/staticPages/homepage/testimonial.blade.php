...
@section('content')
    ...
    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
        <div class="container-xxl">
            ...
            <form class="form d-flex flex-column flex-lg-row" action="{{ route('homeTestimonialUpdate') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('homeTestimonialView') }}" class="btn btn-light me-5">Cancel</a>
