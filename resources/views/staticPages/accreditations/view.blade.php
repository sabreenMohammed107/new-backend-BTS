    ...
    <div class="toolbar" id="kt_toolbar">
        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                <!--begin::Title-->
                <h1 class="text-dark fw-bolder my-1 fs-2">accreditations</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb fw-bold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted">accreditations</li>
...
@section('content')
    ...
    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
        <div class="container-xxl">
            ...
            <form class="form d-flex flex-column flex-lg-row" action="{{ route('accreditationsUpdate') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('accreditationsView') }}" class="btn btn-light me-5">Cancel</a>
