    ...
    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar">
											<a href="{{ route('expertise.create') }}" class="btn btn-primary">Add expertise</a>
     ...
     <tr>
        ...
        <td class="text-end pe-0">
            ...
            <span class="fw-bolder">{{ $row->text}}</span>
        </div>
        </td>
        <!--end::SKU=-->
        <!--begin::Action=-->
        <td class="text-end">
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                ...
                <div class="menu-item px-3">
                    <a href="{{ route('expertise.edit', $row->id) }}"
        ...
        <form id="delete_{{$row->id}}" action="{{ route('expertise.destroy', $row->id) }}"  method="POST" style="display: none;">
        @csrf
        @method('DELETE')
