...
<!--begin::Post-->
    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
        ...
        @endif
            ...
            action="{{ route('venue.update', $row->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
               <!--begin::Main column-->
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input id="venue_en_name" type="text" class="form-control @error('venue_en_name') is-invalid @enderror" name="venue_en_name" value="{{ $row->venue_en_name }}" required autocomplete="venue_en_name" autofocus>
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <select  class="form-select form-select-solid" name="country_id" data-control="select2"
                                ...
                                @foreach ($countries as $country)
                                    <option value="{{ $country->id }}" {{ $row->country_id == $country->id ? 'selected' : '' }} >{{ $country->country_en_name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <!--end::Input group-->
