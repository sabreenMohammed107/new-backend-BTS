    ...
    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
     ...
     <tr>
        ...
        <!--end::Checkbox-->
            <td>
                ...
                <div class="d-flex align-items-center">
                    ...
                    data-kt-ecommerce-category-filter="category_name" > <img src="{{ asset('uploads/gallery')}}/{{ $row->image_path }}" alt="{{ $row->image_path }}" class="w-50"></a>
        ...
        <td class="text-end pe-0">
            ...
            <span class="fw-bolder">{{ $row->order ?? "" }}</span>
        </div>
        </td>
        <!--end::SKU=-->
        ...
        <form id="delete_{{$row->id}}" action="{{ route('gallery.destroy', $row->id) }}"  method="POST" style="display: none;">
        @csrf
        @method('DELETE')
