    ...
    <div class="toolbar" id="kt_toolbar">
        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                <!--begin::Title-->
                <h1 class="text-dark fw-bolder my-1 fs-2">Tailor Submissions</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb fw-bold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted">Tailor Submissions</li>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-100px">Course Title</th>
                        ...
                        <tbody class="fw-bold text-gray-600">
                            @foreach ($rows as $index => $row)
                                ...
                                <tr>
                                    ...
                                    <!--begin::Company-->
                                    <td>
                                        <span class="fw-bolder">{{ $row->company }}</span>
                                    </td>
                                    <!--end::Company-->

                                    <!--begin::Course Title-->
                                    <td>
                                        <span class="fw-bolder">{{ $row->title }}</span>
                                    </td>
                                    <!--end::Course Title-->

                                    <!--begin::City-->
                                    <td>
                                        <span class="fw-bolder">{{ $row->city }}</span>
                                    </td>
                                    <!--end::City-->
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                ...
                                                <form id="delete_{{ $row->id }}"
                                                    action="{{ route('tailorCourse.destroy', $row->id) }}" method="POST"
                                                    style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
