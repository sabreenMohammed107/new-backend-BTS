...
@section('content')
    ...
    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
     ...
     <tr>
        ...
        <td>
            ...
            <td>
                ...
                <div class="d-flex align-items-center">
                    ...
                    data-kt-ecommerce-category-filter="category_name" >{{ $row->job_name }}</a>
                    <!--end::Title-->
                </div>
        </td>
        <!--end::Category=-->
        ...
        <form id="delete_{{$row->id}}" action="{{ route('career.destroy', $row->id) }}"  method="POST" style="display: none;">
        @csrf
        @method('DELETE')
