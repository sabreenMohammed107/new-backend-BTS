    ...
    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
     ...
     <tr>
        ...
        <!--end::Checkbox-->
            <td>
                ...
                <div class="d-flex align-items-center">
                    ...
                    data-kt-ecommerce-category-filter="category_name" >{{ $row->branch_name }}</a>
                    <!--end::Title-->
                </div>
        </td>
        <!--end::Category=-->
        ...
        <td class="text-end pe-0">
            ...
            <span class="fw-bolder">{{ $row->address}}</span>
        </div>
        </td>
        <!--end::SKU=-->
        <td class="text-end pe-0">
        ...
        <td class="text-end pe-0">
            <div class="d-flex align-items-center">
            <span class="fw-bolder">{{$row->venue->venue_en_name ?? ''}} - {{$row->country->country_en_name ?? ''}}</span>
        </div>
        </td>
        <!--begin::Action=-->
        <td class="text-end">
        ...
        <form id="delete_{{$row->id}}" action="{{ route('branches.destroy', $row->id) }}"  method="POST" style="display: none;">
        @csrf
        @method('DELETE')
