    ...
    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar">
											<a href="{{ route('bts-numbers.create') }}" class="btn btn-primary">Add number</a>
     ...
     <tr>
        ...
        <!--end::Checkbox-->
            <td>
                ...
                <div class="d-flex align-items-center">
                    ...
                    data-kt-ecommerce-category-filter="category_name" >{{ $row->bts_number_en_name }}</a>
                    <!--end::Title-->
                </div>
        </td>
        <!--end::Category=-->
        ...
        <td class="text-end pe-0">
            ...
            <span class="fw-bolder">{{ $row->bts_number_value}}</span>
        </div>
        </td>
        <!--end::SKU=-->
        ...
        <td class="text-end">
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                ...
                <div class="menu-item px-3">
                    <a href="{{ route('bts-numbers.edit', $row->id) }}"
        ...
        <form id="delete_{{$row->id}}" action="{{ route('bts-numbers.destroy', $row->id) }}"  method="POST" style="display: none;">
        @csrf
        @method('DELETE')
