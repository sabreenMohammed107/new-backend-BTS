                       ...
                       <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-100px" style="width: 50px !important"> Name</th>
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            <tr>
                                ...
                                <!--begin::Course-->
                                <td>
                                    <span class="fw-bolder">{{ $row->career->job_name ?? 'N/A' }}</span>
                                </td>
                                <!--end::Course-->
                                ...
                                <!--begin::Register Date-->
                                <td>
                                    <span class="fw-bolder">{{ \Carbon\Carbon::parse($row->created_at)->format('d-m-Y') }}</span>
                                </td>
                                <!--end::Register Date-->
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{ route('jobApplicant.show', $row->id) }}"
                                        ...
                                        <div class="menu-item px-3">
                                            ...
                                            <form id="delete_{{ $row->id }}" action="{{ route('jobApplicant.destroy', $row->id) }}" method="POST" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </div>
