...
@section('content')
    ...
    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
     ...
     <tr>
        ...
        <!--end::Checkbox-->
            <td>
                ...
                <div class="d-flex align-items-center">
                    ...
                    data-kt-ecommerce-category-filter="category_name" >{{ $row->reviewer_name }}</a>
                    <!--end::Title-->
                </div>
        </td>
        <!--end::Category=-->
        ...
        <td class="text-end pe-0">
            ...
            <span class="fw-bolder">{{ $row->reviewer_text}}</span>
        </div>
        </td>
        <!--end::SKU=-->
    <!--begin::SKU=-->
    <td class="text-end pe-0">
        <div class="d-flex align-items-center">
        <span class="fw-bolder">{{ $row->reviewer_star_rate}}</span>
    </div>
    </td>
    <!--end::SKU=-->
        <!--begin::Action=-->
        ...
        <form id="delete_{{$row->id}}" action="{{ route('testimonial.destroy', $row->id) }}"  method="POST" style="display: none;">
        @csrf
        @method('DELETE')
